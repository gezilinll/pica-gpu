function clampTo8(i: number) { return i < 0 ? 0 : (i > 255 ? 255 : i); }
function clampNegative(i: number) { return i >= 0 ? i : 0; }
...
//
export function convolveHor(src: Uint8ClampedArray | Uint16Array, dest: Uint16Array, srcW: number, srcH: number, destW: number, filters: Int16Array) {
...
//
export function convolveVert(src: Uint8ClampedArray | Uint16Array, dest: Uint8Array | Uint16Array, srcW: number, srcH: number, destW: number, filters: Int16Array) {
...
//
export function convolveHorWithPre(src: Uint8ClampedArray | Uint16Array, dest: Uint8Array | Uint16Array, srcW: number, srcH: number, destW: number, filters: Int16Array) {
...
//
export function convolveVertWithPre(src: Uint8ClampedArray | Uint16Array, dest: Uint8Array | Uint16Array, srcW: number, srcH: number, destW: number, filters: Int16Array) {
